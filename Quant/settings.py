...
SECRET_KEY = 'ylf_(+1n%m%mb0qc!d^c^42)s)f(ar00mputgns)wb^w7hy(-s'
...
LOGIN_REDIRECT_URL = 'adminpanel:form-list'
...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'toolbar_YourCustomToolbarConfig': [
            ...
            {'name': 'insert',
             'items': ['Image', 'Flash', 'Table', 'Update', 'HorizontalRule', 'Smiley', 'SpecialChar', 'PageBreak',
                       'Iframe']},
            '/',
